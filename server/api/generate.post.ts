...
const StyleToPromptMap = {
  none: "",
  photorealistic:
    ", photorealistic, highly detailed, 8k, sharp focus, perfect lighting, high quality, professional",
  ...
  "pixel-art":
    "pixel art, pixel illustration, pixel drawing, pixel graphic novel, pixel superhero",
